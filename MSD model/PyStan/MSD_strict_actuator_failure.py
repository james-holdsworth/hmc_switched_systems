...
# time of switch
t_switch = 77
# try to trick it by making zero input for some time
u[:,10:60] = 0.0
for k in range(T):
...
y[1,t_switch:] = (-k_true*z_sim[0,t_switch:-1] -b_true*z_sim[1,t_switch:-1] + 0*u[0,t_switch:])/(m_true) # u doesnt work
...
# avoid recompiling
model_name = 'MSD_strict_actuator_failure'
